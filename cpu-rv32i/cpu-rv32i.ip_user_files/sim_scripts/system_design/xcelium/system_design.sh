...
#
# Script generated by Vivado on Fri Jul 05 21:05:47 +0200 2024
...
#
# Usage        : system_design.sh
#                system_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                system_design.sh [-reset_run]
#                system_design.sh [-reset_log]
#                system_design.sh [-help]
#
...
#                script (type 'system_design.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_lite_ipif_v3_0_4 -libname lib_pkg_v1_0_3 -libname lib_srl_fifo_v1_0_3 -libname lib_cdc_v1_0_2 -libname axi_uartlite_v2_0_33 -libname xil_defaultlib -libname proc_sys_reset_v5_0_14 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_31 -libname blk_mem_gen_v8_4_7 -libname generic_baseblocks_v2_1_1 -libname axi_infrastructure_v1_1_0 -libname axi_register_slice_v2_1_29 -libname fifo_generator_v13_2_9 -libname axi_data_fifo_v2_1_28 -libname axi_crossbar_v2_1_30 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_lite_ipif_v3_0_4 lib_pkg_v1_0_3 lib_srl_fifo_v1_0_3 lib_cdc_v1_0_2 axi_uartlite_v2_0_33 xil_defaultlib proc_sys_reset_v5_0_14 interrupt_control_v3_1_5 axi_gpio_v2_0_31 blk_mem_gen_v8_4_7 generic_baseblocks_v2_1_1 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_29 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_crossbar_v2_1_30)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "system_design.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./system_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  ...
  xmvlog -work blk_mem_gen_v8_4_7 $xmvlog_opts +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  "../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  "../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  "../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  "../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.system_design xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.system_design -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log system_design_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: system_design.sh [-step]\n\
Usage: system_design.sh [-lib_map_path]\n\
Usage: system_design.sh [-reset_run]\n\
Usage: system_design.sh [-reset_log]\n\
Usage: system_design.sh [-keep_index]\n\
