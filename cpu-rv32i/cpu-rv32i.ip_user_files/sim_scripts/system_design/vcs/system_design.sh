...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  ...
  vlogan -work blk_mem_gen_v8_4_7 $vlogan_opts +v2k +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  ...
  vlogan -work generic_baseblocks_v2_1_1 $vlogan_opts +v2k +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  "../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  "../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_29 $vlogan_opts +v2k +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  "../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  ...
  vlogan -work axi_data_fifo_v2_1_28 $vlogan_opts +v2k +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
  "../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_30 $vlogan_opts +v2k +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/c2c6" +incdir+"../../../../cpu-rv32i.gen/sources_1/bd/system_design/ipshared/ec67/hdl" \
...
reset_run()
{
  files_to_remove=(ucli.key system_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc system_design_simv.daidir vcs_lib c.obj)
